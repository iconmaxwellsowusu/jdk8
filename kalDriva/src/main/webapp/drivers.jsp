                                                        ...
                                                        <div class="form-group row  container justify-content-center">
								                                   <!-- Employee Details  -->
								                                        <div class="col-md-4 mb-3">
																			<label>Driver's Name</label> <input type="text" class="form-control"
																				placeholder="" name="Name" id="Name11" required>
																		</div>
																		...
																		<label for="" class="mt-1">Gender</label>
																		 ...
																		 <div class="form-group floating-label col-md-4 mb-3">
																		<label for="" class="mt-1">Branch</label>
																			<input type="text" class="form-control"
																				placeholder="" name="branch1" id="branch1">
																		</div>
																		...
																		<div class="col-md-4 mb-3">
								                                             ...
								                                             <div class="col-md-4 mb-3">
								                                                <label>Emergency phone</label>
								                                                    <input class="form-control" name="ephone1" id="ephone1">
								                                            </div>
                                ...
                                <div class="page-body">
                                   ...
                                   <!-- Employee Details  -->
										...
										<div class="col-md-4 mb-3">
                                             ...
                                             <div class="col-md-4 mb-3">
                                                <label>Emergency phone</label>
                                                    <input class="form-control" name="ephone" id="ephone">
                                            </div>
                                         ...
                                         <div align="right">
                                           <button class="btn waves-effect waves-light btn-grd-success" onclick="addDriver()">Add a driver</button>        
                                           </div>         
          ...
          <script type="text/javascript">
												...
												function update(ids){
													...
													$.ajax({
										        		  ...
										        		  type:"POST",
										        		  url:"calData.jsp",
										        		  data:{"myid" :ids,"option":'showDri'},
										        		  
										        		  success:function(msg){
										        			  var obj = JSON.parse(msg);
										        			
										        			  $("#Name11").val(obj[0].name);
										        			  $("#gender1").val(obj[0].gender);
										        			  $("#branch1").val(obj[0].station);
										        			  $("#phone1").val(obj[0].phone);
												 ...
												 function addDriver(){
										        	  ...
										        	  $.ajax({
										        		  ...
										        		  type:"POST",
										        		  url:"calData.jsp",
										        		  data:{"Name":$("#Name1").val() ,"gender":$("#gender").val(),"branch":$("#branch").val(),"phone":$("#phone").val(),"ephone":$("#ephone").val(),"option":'addDriver'},
												 ...
												 function edit(){
										        	  ...
										        	  $.ajax({
										        		  ...
										        		  type:"POST",
										        		  url:"calData.jsp",
										        		  data:{"myid" :id,"Name":$("#Name11").val() ,"gender":$("#gender1").val(),"branch":$("#branch1").val(),"phone":$("#phone1").val(),"ephone":$("#ephone1").val(),
										        			  "option":'editDri'},
