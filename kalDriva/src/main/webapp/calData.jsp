...
out.flush();
	...
	String trips = request.getParameter("trip");
	String query="select * from booking where trip='"+trips+"'";
...
while(rs.next())
{
    ...
    String destination = rs.getString("destination");
    String seatNumber = rs.getString("seatNumber");
    String card = rs.getString("idNumber");
...
out.flush();
	...
	String query1 = "select * from trip where id='"+ids+"'";
							...
							out.flush();
								...
								out.flush();
									...
									out.flush();
									    ...
									    bEncrypt.enc(pass,union,branches,name);
									    JSONObject obj = new JSONObject();
									    obj.put("passenger", union);
									    list.add(obj);
